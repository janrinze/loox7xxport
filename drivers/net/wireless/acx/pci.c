...
*/
#ifdef UNUSED
int acxpci_s_write_eeprom(acx_device_t * adev, u32 addr, u32 len,
		      const u8 * charbuf)
{
	u8 *data_verify = NULL;
	unsigned long flags;
...
*/
static int acxpci_s_write_fw(acx_device_t * adev, const firmware_image_t *fw_image,
		  u32 offset)
{
	int len, size;
	u32 sum, v32;
...
#if !ACX_DEBUG
int acxpci_s_issue_cmd_timeo(acx_device_t * adev,
			 unsigned int cmd,
			 void *buffer, unsigned buflen, unsigned cmd_timeout)
{
#else
int acxpci_s_issue_cmd_timeo_debug(acx_device_t * adev,
			       unsigned cmd,
			       void *buffer,
			       unsigned buflen,
...
static void acxpci_update_link_quality_led(acx_device_t * adev)
{
/*	int qual; */
