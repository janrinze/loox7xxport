...
struct ethtool_drvinfo typedef ethtool_drvinfo_t;

struct {
    void (*write_reg32)(acx_device_t *adev, unsigned int offset, u32 val);
    u32 (*read_reg32)(acx_device_t *adev, unsigned int offset);
    void (*set_regbits)(acx_device_t *adev, unsigned int offset, u32 bits);
    void (*clear_regbits)(acx_device_t *adev, unsigned int offset, u32 bits);
    ...
    int (*s_issue_cmd_timeo_debug)(acx_device_t *adev, unsigned cmd, void *param, unsigned len, unsigned timeout, const char* cmdstr);
    int (*s_issue_cmd_timeo)(acx_device_t *adev, unsigned cmd,	void *param, unsigned len, unsigned timeout);
    char* (*s_proc_diag_output)(char *p, acx_device_t *adev);
    int (*s_reset_dev)(acx_device_t *adev);
    void (*create_desc_queues)(acx_device_t *adev, u32 tx_queue_start, u32 rx_queue_start);
    int (*s_create_hostdesc_queues)(acx_device_t *adev);
