...
#define GPIO_NR_LOOX720_TOUCHPANEL_SPI_CLK      23 // UNKNOWN OUT
#define GPIO_NR_LOOX720_TOUCHPANEL_SPI_CS       24 // UNKNOWN IN
#define GPIO_NR_LOOX720_TOUCHPANEL_SPI_DO	25 // UNKNOWN OUT
#define GPIO_NR_LOOX720_TOUCHPANEL_SPI_DI	26 // UNKNOWN IN
