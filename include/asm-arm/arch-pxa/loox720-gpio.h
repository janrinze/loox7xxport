...
#define GPIO_NR_LOOX720_EARPHONE_DET_N		75 // UNKNOWN OUT

#define GPIO_NR_LOOX720_IR_ON_N			81 // UNKNOWN OUT

#define GPIO_NR_LOOX720_TOUCHPANEL_SPI_DI	86 // UNKNOWN OUT
#define GPIO_NR_LOOX720_TOUCHPANEL_SPI_DO	87 // UNKNOWN IN
